...
import { IgrTemplateColumn } from 'igniteui-react-grids/ES5/igr-template-column';
import { IgrColumn } from 'igniteui-react-grids/ES5/igr-column';
...
import { IgrItemToolTipLayer } from 'igniteui-react-charts/ES5/igr-item-tool-tip-layer';
import { IgrTextHeader } from 'igniteui-react-grids/ES5/igr-text-header';
...
import { DataBindingEventArgs } from 'igniteui-react-grids/ES5/igr-data-binding-event-args';
...
import { CellStyleRequestedEventArgs } from 'igniteui-react-grids/ES5/igr-cell-style-requested-event-args';
import { TemplateCellUpdatingEventArgs } from 'igniteui-react-grids/ES5/igr-template-cell-updating-event-args';
import { TemplateCellInfo } from 'igniteui-react-grids/ES5/igr-template-cell-info';
...
export default class App extends Component<any, IAppState> {
    ...
    public onPriceStyleKey(grid: IgrColumn, args: CellStyleRequestedEventArgs) {
    ...
    public onPriceCellUpdating(grid: IgrTemplateColumn, args: TemplateCellUpdatingEventArgs) {
        let item = args.cellInfo.rowItem;
        let priceShiftUp = item.Change >= 0;
        let templ = args.cellInfo as TemplateCellInfo;
    ...
    public onPricePercentStyleKey(grid: IgrColumn, args: CellStyleRequestedEventArgs) {
    ...
    public onPricePercentCellUpdating(grid: IgrTemplateColumn, args: TemplateCellUpdatingEventArgs) {
        let templ = args.cellInfo as TemplateCellInfo;
    ...
    public onPriceAmountStyleKey(grid: IgrColumn, args: CellStyleRequestedEventArgs) {
        if (args.resolvedValue >= 0) {
    ...
    public onPriceAmountCellUpdating(grid: IgrTemplateColumn, args: TemplateCellUpdatingEventArgs) {
        let templ = args.cellInfo as TemplateCellInfo;
        let priceShiftUp = templ.value >= 0;
    ...
    public onChartStyleKey(grid: IgrColumn, args: CellStyleRequestedEventArgs) {
        args.styleKey = "chart";
    }

    public onChartCellUpdating(grid: IgrTemplateColumn, args: TemplateCellUpdatingEventArgs) {
        if (args.isCanvasBased) {
            return;
        }
        let templ = args.cellInfo as TemplateCellInfo;
    ...
    public onGridStyleKey(grid: IgrColumn, args: CellStyleRequestedEventArgs) {
        args.styleKey = "grid";
    }

    public onGridCellUpdating(grid: IgrTemplateColumn, args: TemplateCellUpdatingEventArgs) {
        if (args.isCanvasBased) {
            return;
        }
    ...
    public onGridGroupingAdd() {
        let g = new ColumnGroupDescription();
    ...
    public onPriceDataBound(sender: any, args: DataBindingEventArgs) {
