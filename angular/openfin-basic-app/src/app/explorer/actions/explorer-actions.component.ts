...
export class ExplorerActionsComponent implements AfterViewInit {
    title = 'IG Explorer with FDC3 Subscriptions';
    ...
    public async InitializeFDC3(): Promise<void> {
        ...
        console.log('app InitializeFDC3');
    ...
    public ClearHistory(): void {
        console.log('app ClearHistory...');

        this.messageCount = 0;
        this.messageHistory.nativeElement.textContent = '';
        console.log('app ClearHistory... done');

    }

    public async ViewChart(symbol: string): Promise<void> {
        console.log('app ViewChart...');
        ...
        console.log('app ViewChart... done');
    }

    public async ViewSector(name: string): Promise<void> {
    ...
    public async ViewPosition(symbol: string): Promise<void> {

        console.log('app ViewPosition...');
        ...
        console.log('app ViewPosition... done');
    }
    ...
    public ReportOpenFinIsMissing(): void {
        ...
        info = info + 'by running "npm run-script openfin" command in terminal \n';
        const old = this.messageHistory.nativeElement.textContent;
        this.messageHistory.nativeElement.textContent = info + old;
    }
